...
void init(GLFWwindow* window) {
    renderingProgram =
        RenderUtil::createShaderProgram("/Users/lanhuidong/CppProjects/opengl-demo/app/src/shaders/vshader_6_2.glsl",
                                        "/Users/lanhuidong/CppProjects/opengl-demo/app/src/shaders/fshader_6_2.glsl");
    ...
    pyr_loc_z = -0.5f;
    setupVertices();
    texture_id = RenderUtil::loadTexture("./app/resources/brick1.jpg");
...
void display(GLFWwindow* window, double currentTime) {
    ...
    m_mat = glm::rotate(m_mat, toRadians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    mv_mat = v_mat * m_mat;
    ...
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, vbo[3]);
    glDrawElements(GL_TRIANGLES, my_torus.getIndices().size(), GL_UNSIGNED_INT, nullptr);
}
...
#endif
    GLFWwindow* window = glfwCreateWindow(800, 800, "Chapter6-Program 6.2", nullptr, nullptr);

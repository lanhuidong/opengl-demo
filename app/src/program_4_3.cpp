...
void init(GLFWwindow* window) {
    renderingProgram =
        RenderUtil::createShaderProgram("/Users/lanhuidong/CppProjects/opengl-demo/app/src/shaders/vshader_4_3.glsl",
                                        "/Users/lanhuidong/CppProjects/opengl-demo/app/src/shaders/fshader_4_3.glsl");
    camera_x = 0.0f;
    camera_y = 0.0f;
    camera_z = 8.0f;
    cube_loc_x = 0.0f;
...
#endif
    GLFWwindow* window = glfwCreateWindow(600, 600, "Chapter4-Program 4.3", nullptr, nullptr);
